...
Usage:
    python spawn_test_client.py                    # Run default PIR->Light scenario
    python spawn_test_client.py --scenario door    # Run door->light scenario
    python spawn_test_client.py --list             # List available scenarios
    python spawn_test_client.py --custom           # Interactive custom event mode
"""
...
from mqtt2ai.core.utils import publish_mqtt
...
def run_scenario(
    ...
    print(f"{green}  Run: cat configs/learned_rules.json{reset}\n")
    return True
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python spawn_test_client.py                     # Run default PIR->Light
  python spawn_test_client.py --scenario door_light
  python spawn_test_client.py --list              # List all scenarios
  python spawn_test_client.py --custom            # Interactive mode
  python spawn_test_client.py --min-delay 2 --max-delay 6
        """
    )
    parser.add_argument(
        "--scenario", "-s",
